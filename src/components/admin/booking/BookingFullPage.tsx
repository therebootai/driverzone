...
const BookingFullPage = () => {
      ...
      const fetchData = async (
        ...
        !statusFilter || statusFilter === "" ? undefined : (statusFilter as GetBookingsParams["status"]);
  ...
  return (
    <div className=' p-6 flex flex-col gap-6'>
        <div>
            <BookingPageHeader searchTerm={searchTerm}
        ...
        <div>
            <ManageBooking   allBookings={allBookings}
