 ...
 const fetchData = async (
  ...
  return (
    <div className='p-6 flex flex-col gap-6'>
      <div>
        <CustomerPageHeader searchTerm={searchTerm} setSearchTerm={setSearchTerm} status={status} setStatus={setStatus}/>
      </div>
      <div className=''>
        <ManageCustomer allCustomer={allCustomer} pagination={pagination} fetchData={fetchData}/>
      </div>
    </div>
  )
}
