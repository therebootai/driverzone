  ...
  return (
    <div className="flex flex-row justify-between items-center">
      <div className=" flex flex-row gap-4 items-center">
        <div>
          <select className=" w-fit px-4 rounded-md h-[2.5rem] bg-custom-gray text-site-black font-semibold text-sm flex justify-center items-center">
      ...
      <div>
        <button  type="button"
        onClick={openAddPopup} className=" h-[2.5rem] px-4 flex gap-2 justify-center items-center bg-gradient-to-r from-site-saffron to-site-skin rounded-md text-site-black font-medium "><AiOutlinePlusCircle /> Add Coupon</button>
      </div>
